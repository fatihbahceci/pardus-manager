...
/**
 * {@link #exec(String)} zaten connect metodunu çağırıyor
 * @throws JSchException
 * @throws IOException
 */
	public void connect() throws JSchException, IOException {	
		//TODO her komut için yeni balantı açıyor. Daha sonra burası için bağlı ise tekrar bağlanmaması için satır ekle
	...
	private String read() throws IOException, JSchException {
		...
		//Trim ifadesi doğru bir kara mı bilemedim. Belki dönen sonuç boşluk içeriyordur. O yüzden trim ifadesini kaldırdım. 
